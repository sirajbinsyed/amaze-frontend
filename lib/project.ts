...
export async function getOrders(): Promise<ApiResponse<Order[]>> {
  try {
    const response = await fetch(`${API_BASE_URL}/projects/orders`, {
      method: 'GET',
...
export async function getOrder(orderId: number): Promise<ApiResponse<Order>> {
  try {
    const response = await fetch(`${API_BASE_URL}/projects/orders/${orderId}`, {
      method: 'GET',
      headers: getAuthHeaders(),
    });
...
export async function getActiveStaffs(): Promise<ApiResponse<{ staffs: Staff[] }>> {
  try {
    const response = await fetch(`${API_BASE_URL}/projects/staffs/active`, {
...
export async function assignTask(payload: AssignTaskPayload): Promise<ApiResponse<{ task: Task }>> {
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/projects/tasks/assign`, {
      method: 'POST',
 ...
 */
 export async function getAllTasks(): Promise<ApiResponse<DetailedTask[]>> {
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/projects/tasks`, {
      method: 'GET',
      headers: getAuthHeaders(),
    });
...
export async function getTasksByOrder(orderId: number): Promise<ApiResponse<DetailedTask[]>> {
  try {
    const response = await fetch(`${API_BASE_URL}/projects/tasks/${orderId}`, {
      method: 'GET',
      headers: getAuthHeaders(),
    });
 ...
 */
 export const getOrderImages = async (orderId: number): Promise<OrderImage[]> => {
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/projects/orders/images/${orderId}`, {
      method: 'GET',
      headers,
    });
