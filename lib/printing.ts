 ...
 */
 export async function getAllTasks(): Promise<ApiResponse<DetailedTask[]>> {
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/printing/tasks`, {
      method: 'GET',
...
export async function editTask(
  ...
  try {
    const response = await fetch(`${API_BASE_URL}/printing/tasks/${taskId}`, {
...
export async function getOrderById(orderId: number): Promise<ApiResponse<OrderDetails>> {
  try {
    const response = await fetch(`${API_BASE_URL}/printing/orders/${orderId}`, {
      method: 'GET',
      headers: getAuthHeaders(),
    });
 ...
 */
 export const getOrderImages = async (orderId: number): Promise<OrderImage[]> => {
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/printing/orders/images/${orderId}`, {
      method: 'GET',
      headers,
    });
